...
namespace FLOG_BE.Features.Companies.CompanyAddress.PutCompanyAddress
{
    public class Handler : IAsyncRequestHandler<Request, Response>
    {
        ...
        public async Task<ApiResult<Response>> Handle(Request request)
        {
            ...
            var companyaddress = await _context.CompanyAddresses.FirstOrDefaultAsync(x => x.CompanyAddressId == Guid.Parse(request.Body.CompanyAddressId));
