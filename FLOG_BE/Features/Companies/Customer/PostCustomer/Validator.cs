...
namespace FLOG_BE.Features.Companies.Customer.PostCustomer
{
    public class Validator : AsyncRequestValidator<Request>
    {
        ...
        protected override async Task<ValidationResult> Validate(Request request)
        {
            ...
            if (string.IsNullOrEmpty(request.Body.ReceivableAccountNo))
                return ValidationResult.ValidationError($"{nameof(request.Body.ReceivableAccountNo)} cannot be null");
