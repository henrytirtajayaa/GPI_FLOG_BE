...
namespace FLOG_BE.Features.Finance.APApply.GetHistoryApplyPayable
{
    public class Handler : IAsyncRequestHandler<Request, Response>
    {
        ...
        private IQueryable<Entities.APApplyHeader> getTransaction(string personId, RequestFilter filter)
        {
            ...
            var queryPayments = _context.ApPaymentHeaders.Where(x => x.Status == DOCSTATUS.POST || x.Status == DOCSTATUS.VOID).ToList();
