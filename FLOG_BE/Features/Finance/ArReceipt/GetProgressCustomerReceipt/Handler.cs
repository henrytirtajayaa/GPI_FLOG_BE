...
namespace FLOG_BE.Features.Finance.ArReceipt.GetProgressCustomerReceipt
{
    public class Handler : IAsyncRequestHandler<Request, Response>
    {
        ...
        private IQueryable<Entities.ArReceiptHeader> GetArReceipt(string personId, RequestFilter filter)
        {
            ...
            var query = (from x in _context.ArReceiptHeaders
                         ...
                         where x.Status == DOCSTATUS.NEW || x.Status == DOCSTATUS.PROCESS || x.Status == DOCSTATUS.APPROVE || x.Status == DOCSTATUS.DISAPPROVE                          
                         select new Entities.ArReceiptHeader
                         {
                             ...
                             ArReceiptDetails = (from s in _context.ArReceiptDetails
                                                 ...
                                                 on s.ReceiveTransactionId equals b.ReceiveTransactionId into JoinA from ja in JoinA.DefaultIfEmpty()
