...
namespace FLOG_BE.Features.Finance.DepositSettlement.PutStatusDepositSettlement
{
    public class Validator : AsyncRequestValidator<Request>
    {
        ...
        {
            if (string.IsNullOrEmpty(request.Body.SettlementHeaderId.ToString()))
                return ValidationResult.ValidationError($"{nameof(request.Body.SettlementHeaderId)} cannot be null");
