...
namespace FLOG_BE.Features.Sales.NegotiationSheet.GetNegotiationSheetProgress
{
    public class Handler : IAsyncRequestHandler<Request, Response>
    {
        ...
        public Handler(IHttpContextAccessor httpContextAccessor, FlogContext contextCentral, CompanyContext context, ILogin login, HATEOASLinkCollection linkCollection)
        {
            ...
            _login = login;
            _docGenerator = new DocumentGenerator(_context, _contextCentral);
        }
        ...
        private IQueryable<Entities.NegotiationSheetHeader> getSalesData(string personId, RequestFilter filter)
        {
            ...
            var query = (from ng in _context.NegotiationSheetHeaders
                         ...
                         select new Entities.NegotiationSheetHeader {
                             ...
                             NsContainers = (from cont in _context.NegotiationSheetContainers 
                                             ...
                                             where cont.NegotiationSheetId == ng.NegotiationSheetId orderby cont.RowIndex ascending select new Entities.NegotiationSheetContainer { 
                             ...
                             NsTruckings = (from truck in _context.NegotiationSheetTruckings 
                                            ...
                                            where truck.NegotiationSheetId == ng.NegotiationSheetId orderby truck.RowIndex ascending
                             ...
                             NsSellings = (from sell in _context.NegotiationSheetSellings 
                                           ...
                                           where sell.NegotiationSheetId == ng.NegotiationSheetId orderby sell.RowIndex ascending 
            ...
            //BEGIN CURRENT APPROVER
            foreach (var ns in query)
            {
                if (ns.Status == DOCSTATUS.PROCESS)
                {
                    ns.CurrentApprovers = _docGenerator.GetCurrentDocumentApprovers(TRX_MODULE.TRX_SALES, DOCNO_FEATURE.TRXTYPE_SALES_NEGOSHEET, ns.TransactionType, ns.NegotiationSheetId);
                }
                else
                {
                    ns.CurrentApprovers = new List<TrxPersonApprover>();
                }
            }
