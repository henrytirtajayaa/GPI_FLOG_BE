...
namespace FLOG_BE.Features.Finance.Sales.Quotation.SubmitQuotation
{
    public class Handler : IAsyncRequestHandler<Request, Response>
    {
        ...
        public async Task<ApiResult<Response>> Handle(Request request)
        {
            ...
            using (var transaction = _context.Database.BeginTransaction())
            {
                ...
                if (editted != null)
                {
                    ...
                    {
                        return ApiResult<Response>.ValidationError("Sales Quotation can not be submitted !");
                    }
                }
                else
                {
        ...
        private async Task<List<Entities.SalesQuotationDetail>> InsertDetails(SubmitQuotationBody body, Entities.SalesQuotationHeader header)
        {
