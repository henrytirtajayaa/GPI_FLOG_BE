...
{
    public class NegotiationSheetSelling
    {
        public NegotiationSheetSelling()
        {
        ...
        [NotMapped]
        public virtual List<Entities.NegotiationSheetBuying> NsBuyings { get; set; }
        ...
        [NotMapped]
        public string ReceiveDocumentNo { get; set; }
    }
}
