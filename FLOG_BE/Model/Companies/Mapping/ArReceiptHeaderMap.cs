...
{
    public class ArReceiptHeaderMap : IEntityTypeConfiguration<Entities.ArReceiptHeader>
    {
        public void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<Entities.ArReceiptHeader> builder)
        {
            builder.ToTable("ar_receipt_header", "dbo");

            builder.HasKey(t => t.ReceiptHeaderId);
