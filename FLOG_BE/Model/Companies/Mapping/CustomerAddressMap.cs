...
{
    public class CustomerAddressMap : IEntityTypeConfiguration<Entities.CustomerAddress>
    {
        public void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<Entities.CustomerAddress> builder)
        {

            builder.ToTable("customer_address", "dbo");
            builder.HasKey(t => t.CustomerAddressId);

            builder.Property(t => t.CustomerAddressId)
                .IsRequired()
