...
{
    public class NegotiationSheetBuyingMap : IEntityTypeConfiguration<Entities.NegotiationSheetBuying>
    {
        public void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<Entities.NegotiationSheetBuying> builder)
        {

          
            builder.ToTable("negotiation_sheet_buying", "dbo");
            builder.HasKey(t => t.NsBuyingId);
            
            builder.Property(t => t.NsBuyingId)
                .IsRequired()
                .HasColumnName("ns_buying_id")
