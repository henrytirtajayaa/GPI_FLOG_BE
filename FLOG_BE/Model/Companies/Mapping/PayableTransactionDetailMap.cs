...
{
    public class PayableTransactionDetailMap : IEntityTypeConfiguration<Entities.PayableTransactionDetail>
    {
        public void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<Entities.PayableTransactionDetail> builder)
        {
            builder.ToTable("payable_transaction_detail", "dbo");
