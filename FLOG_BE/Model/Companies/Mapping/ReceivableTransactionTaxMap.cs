...
{
    public class ReceivableTransactionTaxMap : IEntityTypeConfiguration<Entities.ReceivableTransactionTax>
    {
        public void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<Entities.ReceivableTransactionTax> builder)
        {
    
            builder.ToTable("receive_transaction_tax", "dbo");
