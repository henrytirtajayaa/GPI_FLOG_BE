...
{
    public class SalesOrderSellingMap : IEntityTypeConfiguration<Entities.SalesOrderSelling>
    {
        public void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<Entities.SalesOrderSelling> builder)
        {
            builder.ToTable("sales_order_selling", "dbo");
            builder.HasKey(t => t.SalesOrderSellingId);
