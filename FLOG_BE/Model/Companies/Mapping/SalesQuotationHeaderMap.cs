...
{
    public class SalesQuotationHeaderMap : IEntityTypeConfiguration<Entities.SalesQuotationHeader>
    {
        public void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<Entities.SalesQuotationHeader> builder)
        {
            builder.ToTable("sales_quot_header", "dbo");

     
            builder.HasKey(t => t.SalesQuotationId);
