...
{
    public class CompanyAddressProfiles : Profile
    {
        public CompanyAddressProfiles()
        {
            CreateMap<FLOG_BE.Model.Companies.Entities.CompanyAddress, Features.Companies.CompanyAddress.GetCompanyAddress.ResponseItem>()
                .ForMember(dest => dest.CompanyAddressId, opt => opt.MapFrom(src => src.CompanyAddressId))
